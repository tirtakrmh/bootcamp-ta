...
include"conn.php";
$id = $_GET['id'];
$qry = mysqli_query($conn,"SELECT * from scare where id_scare='$id'");
      ...
      <div class="container-fluid">
        ...
        <div class="nav navbar-nav navbar-right">
         <ul id="nav">
          ...
          <li class="a"><a href="" style="color:#fff;"><span class="glyphicon glyphicon-shopping-cart"> Shop |</span></a></li>
     ...
     <img src="gambar/<?php echo $data['image']; ?>" style="width:250px; height:250px;">   
      ...
      <div class="col-md-6" style="margin-left:10px ; margin-top:10px;">
        <table>
         ...
         <a href="login_tirta.php?pesan=a" class="btn btn-success">BUY</a>
        </div>
    </div>
    </div>
      ...
      <div class="col-md-3" style="margin-top:20px;">
        ...
        <center><img src="gambar/<?php echo $scare['image'] ?>" style="margin-top:20px; width:210px;height:190px;"></center>
         <h3 style="text-align:center; color:black;"><?php echo $scare['brand'] ?></h3>
          <center><b>Harga</b> Rp.<?php echo $scare['price']; ?></center> 
          <center><b>Stok</b> (<?php echo $scare['stock']; ?>)</center>
